function changeBar(){
	var order, source, w, h, column, row, url, base_url;
	base_url = "https://alexbra.github.io/"
	...
	url = base_url+"data/fifa_by_region_wide.csv"
	drawStackedBarChart(url,heading)
	}
	else
...
function drawStackedBarChart(url,heading){
